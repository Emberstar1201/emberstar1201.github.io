...
const characters = [
  ...
  },
  {
    ...
    soulNature: "死生天平",
    location: "净土",
    description: "由生命之神-希塔娜创造的『神之子嗣』，虽非星荧血亲却情同手足。肩负维系生死平衡的职责，但不受任何神明操控。能同时感知方圆五公里内所有生命的诞生与消亡。本是注定的命运，从创造之初就有了自身的命运，能力与职责，但她也是自由的，拥有独自选择自己的生活与命运走向，同时也是备受爱戴的存在。
这是命运的指引，她们注定会相遇和陪伴。",
