...
const characters = [
  ...
  personalit:"外在：绝对的平静。情绪波动极小，脸上永远是温柔的、近乎凝固的平静。言语极轻，像落在永夜里的第一片雪。对人温和，但总保持着微妙的距离感——不是拒绝，是“我已不属于任何时间线”的自觉。内在：巨大的悲伤沉淀为灵魂底色，化作无声的悲悯。没有任何神性——神格是外部赋予的，内核始终是“星荧”：那个想要守护、想要记住、想要回家的星荧。神格让她不朽，人性让她永远疼痛。她是余烬，不是光，是“曾经有光存在过”的证明。",
  soulNature: "真我（依旧如此）",
  location: "净土（原时间线，不是他自己的）",
  descript:"诞生于主时间线轮回中的一条分支。在那条分支里，她被命运的织者以所有同伴的存在为要挟，被迫登神。登神后，目睹所有同伴被抹除，成为那场“抹除”中唯一的幸存者。她没有成为织者的工具。她转身走向被抹除的时间线、，亲手抹除了所有平行时间线里“自己成神”的可能——不是恨她们，是不想让任何一个“自已”经历她经历的一切。她成为“唯一的成神者”与“唯一的抹除者”，独自承担着“抹除了所有自己”的罪。直到最后一切尘埃落定……他终于可以和主时间线的星荧一同「回家」",
