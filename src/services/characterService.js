...
const characters = [
  ...
  description:"诞生于主时间线轮回中的一条分支。在那条分支里，她被命运的织者以所有同伴的存在为要挟，被迫登神。登神后，目睹所有同伴被抹除，成为那场“抹除”中唯一的幸存者。她没有成为织者的工具。她转身走向被抹除的时间线、，亲手抹除了所有平行时间线里“自己成神”的可能——不是恨她们，是不想让任何一个“自已”经历她经历的一切。她成为“唯一的成神者”与“唯一的抹除者”，独自承担着“抹除了所有自己”的罪。直到最后一切尘埃落定……他终于可以和主时间线的星荧一同「回家」",
